...
const defaultRoutes = [
	...
	{ path: '/', name: 'index', component: $i ? page('channels') : page('welcome') },
	...
	{ path: '/channels/category/:categoryName', component: page('channel.category'), props: true },
	{ path: '/channels/sub-category/:subCategoryId', component: page('channel.sub-category'), props: true },
	{ path: '/channels/:channelId/edit', component: page('channel-editor'), props: route => ({ channelId: route.params.channelId }) },
