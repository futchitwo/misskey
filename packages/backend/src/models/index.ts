...
import { ChannelSubLeader } from './entities/channel-sub-leader.js';
import { ChannelFollowRequest } from './entities/channel-follow-request.js';
import { ChannelBannedUser } from './entities/channel-banned-user.js'; 
import { ChannelCategoryRepository } from './repositories/channel-category.js';
import { ChannelSubCategoryRepository } from './repositories/channel-sub-category.js';
...
export const ChannelSubLeaders = db.getRepository(ChannelSubLeader);
export const ChannelFollowRequests = db.getRepository(ChannelFollowRequest);
export const ChannelBannedUsers = db.getRepository(ChannelBannedUser);
export const ChannelCategory = (ChannelCategoryRepository);
export const ChannelSubCategory = (ChannelSubCategoryRepository);
